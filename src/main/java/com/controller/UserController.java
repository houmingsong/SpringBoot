...
public class UserController {
	...
	@ResponseBody
	public String findByuserNameAnduserTel(@PathVariable("userName") String userName,
			@PathVariable("userTel") String userTel) {
	...
	@ResponseBody
	public String findUserNameAndPassword(@PathVariable("userName") String userName,
	...
	@ResponseBody
	public String findUserNameAndPasswordSql(@PathVariable("userName") String userName,
			@PathVariable("pass") String pass) {
	...
	// @ResponseBody
	// public String getListJson(@PathVariable("tag") String tag,String
	...
	public ModelAndView register(String username, String password, String phone) {
		ModelAndView m = new ModelAndView("show2");
